...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ZFB",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("History")
@interface History : NSManagedObject
@property (nonatomic, copy) NSDate * _Nullable datetime;
@property (nonatomic, copy) NSString * _Nullable meal;
@property (nonatomic, copy) NSString * _Nullable recipeName;
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS_NAMED("Ingredient")
...
@interface Ingredient (SWIFT_EXTENSION(ZFB))
...
@interface Item (SWIFT_EXTENSION(ZFB))
